...
?>
		<a class="button wc-backward" href="<?php echo esc_url(apply_filters('yith_ywraq_return_to_shop_url', $shop_url)); ?>"><?php echo esc_html($label_return_to_shop); ?></a>
	<?php
	}
else :
	?>
	<form id="yith-ywraq-form" name="yith-ywraq-form" action="<?php echo esc_url(YITH_Request_Quote()->get_raq_page_url()); ?>" method="post">
		...
		<table class="shop_table cart  shop_table_responsive" id="yith-ywrq-table-list">
			...
			<tbody>
				...
				?>
						<tr class="<?php echo esc_attr(apply_filters('yith_ywraq_item_class', 'cart_item', $raq_content, $key)); ?>" data-wapo_parent_key="<?php echo esc_attr($raq['yith_wapo_parent_key']); ?>" <?php echo esc_attr(apply_filters('yith_ywraq_item_attributes', '', $raq_content, $key)); ?>>
							...
							<?php if (get_option('ywraq_hide_total_column', 'yes') === 'no' && get_option('ywraq_hide_price') !== 'yes') : ?>
								<td class="product-subtotal" data-title="<?php esc_attr_e('Price', 'yith-woocommerce-request-a-quote'); ?>">
									<?php
					...
					<?php else : ?>
						<tr class="<?php echo esc_attr(apply_filters('yith_ywraq_item_class', 'cart_item', $raq_content, $key)); ?>" <?php echo esc_attr(apply_filters('yith_ywraq_item_attributes', '', $raq_content, $key)); ?>>
							...
							if (apply_filters('ywraq_item_thumbnail', true)) : ?>
				...
				?>
					...
					<tr>
						...
						<td class="raq-totals" data-title="<?php esc_attr_e('Total', 'yith-woocommerce-request-a-quote'); ?>">
							<?php
